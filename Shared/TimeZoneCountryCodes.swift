//
//  TimeZoneCountryCodes.swift
//  touchtime
//
//  Created on 19/07/2026.
//
//  Maps IANA timezone identifiers to ISO 3166-1 alpha-2 country codes.
//  Generated from the tz database's zone.tab, plus fixups for legacy
//  identifiers (e.g. Asia/Calcutta) that ICU still reports.
//  Country display names should be resolved via Locale.localizedString(forRegionCode:)
//  so localization comes from CLDR for free.
//

import Foundation

struct TimeZoneCountryCodes {
    /// ISO 3166-1 alpha-2 country code for a timezone identifier,
    /// or nil for zones without a country (UTC, GMT).
    static func countryCode(for identifier: String) -> String? {
        countryCodeMap[identifier]
    }
    ...
    private static let countryCodeMap: [String: String] = [
        ...
        "Africa/Brazzaville": "CG", // Congo - Brazzaville
        ...
        "Africa/Sao_Tome": "ST", // São Tomé & Príncipe
        ...
        "America/Grand_Turk": "TC", // Turks & Caicos Islands
        ...
        "America/Kralendijk": "BQ", // Caribbean Netherlands
        ...
        "America/St_Barthelemy": "BL", // St. Barthélemy
        ...
        "America/St_Vincent": "VC", // St. Vincent & Grenadines
        ...
        "Asia/Chongqing": "CN", // China mainland
        "Asia/Colombo": "LK", // Sri Lanka
        "Asia/Damascus": "SY", // Syria
        "Asia/Dhaka": "BD", // Bangladesh
        "Asia/Dili": "TL", // Timor-Leste
        "Asia/Dubai": "AE", // United Arab Emirates
        "Asia/Dushanbe": "TJ", // Tajikistan
        "Asia/Famagusta": "CY", // Cyprus
        "Asia/Gaza": "PS", // Palestinian Territories
        "Asia/Harbin": "CN", // China mainland
        "Asia/Hebron": "PS", // Palestinian Territories
        ...
        "Asia/Kashgar": "CN", // China mainland
        ...
        "Asia/Shanghai": "CN", // China mainland
        ...
        "Atlantic/South_Georgia": "GS", // So. Georgia & So. Sandwich Isl.
        ...
        "Indian/Chagos": "IO", // Chagos Archipelago
        ...
        "Pacific/Johnston": "UM", // U.S. Outlying Islands
        ...
        "Pacific/Midway": "UM", // U.S. Outlying Islands
        ...
        "Pacific/Wake": "UM", // U.S. Outlying Islands
